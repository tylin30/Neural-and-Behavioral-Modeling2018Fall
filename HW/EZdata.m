...
%EZdata  --  EZ-diffusion model for response time and accuracy
%
% [Pc,VRT,MRT] = EZdata(v,a,Ter)
% [Pc,VRT,MRT] = EZdata(v,a,Ter,s)
%
...
%
% EZdata transforms the triad [Pc,VRT,MRT] into the triad [v,a,Ter]:
...
%  
% See also EZdatafit, dprime2Pcorr.
